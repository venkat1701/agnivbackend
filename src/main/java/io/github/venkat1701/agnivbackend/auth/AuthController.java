...
public class AuthController {
     ...
     */
    @PostMapping("/signup")
    public ResponseEntity<AuthResponse> createUserHandler(@RequestBody UserRegistrationDTO userDto) throws ExecutionControl.UserException, UserException {
        ...
        return ResponseEntity.ok().body(new AuthResponse(jwt, "" + createdUser.getId()));
    }
